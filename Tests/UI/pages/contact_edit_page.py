...
class ContactEditsPage(BasePage):
    ...
    def enter_contact_details(self, contact_details):
        ...
        self.wait_for_element(self.address1_input).send_keys(
            contact_details["street1-2"]
        )
        self.wait_for_element(self.address2_input).clear()
        self.wait_for_element(self.address2_input).send_keys(
            contact_details["street2-2"]
        )
